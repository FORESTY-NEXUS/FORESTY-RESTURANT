   ...
   className="hero relative min-h-full lg:min-h-screen flex flex-col justify-start lg:justify-between items-center overflow-x-hidden bg-[#212121] text-white pt-20 pb-10" id="home" ref={heroRef}>
      <div className="hero-content w-full flex flex-col items-center justify-center lg:block">
        <div className="hero-showcase relative flex flex-col items-center justify-center w-full mt-[1vh] lg:mt-[16vh]">
          <h1 className="hero-title text-center lg:absolute lg:top-[5%] lg:left-[50%] text-[clamp(3.5rem,12vw,15rem)] font-black whitespace-nowrap z-0 tracking-tighter pointer-events-none">ZAIQA HUB</h1>
        ...
        <div className="w-full px-[5%] mt-2 flex flex-col items-center gap-8 lg:mt-0 lg:absolute lg:bottom-0 lg:left-0 lg:py-10 lg:flex-row lg:justify-between lg:items-end lg:gap-0 z-20">
          
          <p className="hero-copy  text-sm  max-w-[320px] lg:text-lg font-semibold 
